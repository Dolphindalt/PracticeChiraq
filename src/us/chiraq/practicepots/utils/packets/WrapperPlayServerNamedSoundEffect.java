  ...
  extends AbstractPacket
{
  ...
  {
    return ((Integer)this.handle.getIntegers().read(0)).intValue() / 8.0D;
  }
  ...
  {
    return ((Integer)this.handle.getIntegers().read(1)).intValue() / 8.0D;
  }
  ...
  {
    return ((Integer)this.handle.getIntegers().read(2)).intValue() / 8.0D;
  }
  ...
  {
    return ((Integer)this.handle.getIntegers().read(3)).intValue() / 63.0F;
  }
